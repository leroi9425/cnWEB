<?php
    $list_flower = [
        ...
        "image" => "image\hoa-dong-tien.webp"],
        ["name" => "Hoa giấy",
        ...
        "image" => "image\hoa-cam-chuong.webp"],
        ["name" => "Hoa huỳnh anh",
        ...
        "image" => "image\hoa-huynh-anh.webp"],
        ["name" => "Hoa Păng-xê",
        ...
        "image" => "image\hoa-cuc-dai.webp"]
    ];

    session_start();
    if(count($_SESSION) <= 0){
        $_SESSION['flowers'] = $list_flower;
    }
?>
...
<body>
    <h1>Quản lý trang web về hoa</h1>
        ...
        <table>
            ...
            <?php 
                foreach($_SESSION['flowers'] as $index => $value){
                    ...
                    <td>'.$value["name"].'</td>
                    <td>'.$value["detail"].'</td>
                    <td><img class="flower-img" src="'.  $value["image"] .'" alt="'. $value["name"] .'"></td>
                    <td>
                        <a href="edit.php?index='.$index.'"><img class="icon" src="icon/edit.png" alt="sua anh"></a>
                    </td>
                    <td>
                        <a href="delete.php?index='.$index.'"><img class="icon" src="icon/delete.png" alt="xoa anh"></a>
                    </td>
                    </tr>';
                }
            ?>
